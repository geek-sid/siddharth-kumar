    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-16 px-6">
        <div className="container mx-auto text-center">
          <div className="animate-fade-in">
            <h1 className="text-5xl md:text-7xl md:leading-[1.5] font-bold bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent mb-6">
              Engineering Manager
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Building high-performing teams and scalable systems. 12+ years of
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in">
              <div className="w-80 h-80 mx-auto bg-gradient-to-br from-primary/20 to-primary-glow/20 rounded-2xl flex items-center justify-center">
                <img alt="Siddharth Kumar" src="https://imgproxy.gamma.app/resize/quality:80/resizing_type:fit/width:1200/https://cdn.gamma.app/d355mkju93fs9ii/6ceb5febffad4ea1999dd25edd5dfb22/original/WhatsApp-Image-2024-10-02-at-23.10.51.jpeg"></img>
              </div>
            </div>
            <div className="animate-fade-in">
              <p className="text-lg text-muted-foreground mb-6">
                Engineering Manager with over 12+ years of extensive experience
                in product development. Acknowledged for conducting coordination
                between multiple teams and working in all phases of Software
                Development from Requirements gathering to Acceptance Testing.
              </p>
              <p className="text-lg text-muted-foreground mb-6">
                Excellent Communication Skills with good experience in solving
                mission-critical issues, root cause analysis and accountability.
            ...
            {[
              {
                ...
                description:
                  "B.TECH in Computer Science from ITM University, Gurugram (77%).\n\n Online Certificate in Project Management from IIT Delhi.",
                tech: [
                  "Computer Science",
                  "Project Management",
                  "IIT Delhi",
              ...
              },
              {
                ...
                description:
                  "Successfully qualified GATE 2013. Awarded Google-Udacity Web Development Scholarship and C.B.S.E Central Sector scholarship.",
                tech: [
                  "GATE 2013",
                  "Google Scholarship",
                  "Academic Awards",
              ...
              },
              {
                ...
                description:
                  "Led upgrade of existing AOSEN Product to latest tech stack. Doubled overall frontend team throughput through process improvements.",
                tech: [
                  "Angular",
                  "Spring Boot",
                  "Team Leadership",
              ...
              },
              {
                ...
                description:
                  "Responsible for development & release of iOS and Android mobile applications. Introduced unit testing and SonarQube for code quality.",
                tech: [
                  "iOS Development",
                  "Android Development",
                  "Code Quality",
              ...
              },
              {
                ...
                description:
                  "Established best practices for development, infrastructure & deployment. Led all 3rd party integrations and microservices architecture.",
                tech: [
                  "DevOps",
                  "Microservices",
                  "Best Practices",
              ...
              },
              {
                ...
                description:
                  "Created technical requirement documents and LOE for different projects. Trained new interns and coordinated with multiple client teams.",
                tech: [
        ...
        <div className="container mx-auto text-center">
          ...
          <a href="mailto:siddharth.smk@gmail.com">
            ...
            <a target="_blank" href="https://linkedin.com/in/siddharth-kumar009">
              ...
              <a target="_blank" href="https://github.com/geek-sid/">
            <Button variant="outline" size="lg">
      ...
      <footer className="py-8 px-6 border-t">
        <div className="container mx-auto text-center text-muted-foreground">
          <p>
            &copy; 2025.Built with passion for engineering
            excellence.
          </p>
        </div>
      </footer>
